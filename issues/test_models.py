...
class IssuedBookModelTest(TestCase):
    ...
    def test_field_storage_and_retrieval(self):
        ...
        self.assertAlmostEqual(issued_book.due_date, timezone.now() + timedelta(days=14), delta=timedelta(days=1))

    def test_default_due_date(self):
        """
        Ensure the due_date is set to 14 days from the issue_date by default.
        """
    ...
    def test_late_fee_calculation(self):
        """
        Test that the late_fee method calculates the correct fee when the book is returned late.
        """
    ...
    def test_no_late_fee(self):
        """
        Verify that the late_fee method returns 0 if the book is returned on or before the due date.
        """
    ...
    def test_edge_case_no_return_date(self):
        """
        Check that late_fee returns 0 if there is no return_date (i.e., the book hasn't been returned).
        """
