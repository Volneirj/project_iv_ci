...
class BookModelTest(TestCase):
    ...
    This class contains tests to validate the behavior of the Book model,
    including the creation of a book instance and
    optional testing of Cloudinary image uploads.
    """
    ...
    This setting is to avoid to upload a new image everytime
    the tests are running in case of debug.
    """
    ...
    def test_featured_image_default(self):
        """
        Test that the featured_image field has the default
        value when no image is provided.
        """
        book = Book.objects.create(
            title='Test Book',
            author='Test Author',
    ...
    if test_cloud_image:
        def test_featured_image_upload(self):
            """
            Test that the featured_image field properly handles
            an uploaded image file.
            """

            with open(
                'static/media/book_images/placeholder.jpg',
                'rb'
                 ) as image_file:
    ...
    def test_book_update(self):
        """
        Test that updating an existing Book
        instance saves the changes correctly.
        """
        ...
        self.assertEqual(
            ...
            'An updated test book description.'
            )
...
class BookSuggestionModelTest(TestCase):
    ...
    def test_default_value_of_submitted_at(self):
        """
        Test that the submitted_at field is
    ...
    def test_model_save_behavior(self):
        """
        Test that saving a BookSuggestion
        instance correctly updates the database.
        """
        ...
        self.assertEqual(
            BookSuggestion.objects.get(id=suggestion.id).book_title,
            'Another Test Title'
        )
